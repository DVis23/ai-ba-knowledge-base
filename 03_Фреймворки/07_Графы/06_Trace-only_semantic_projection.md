...
Trace-only semantic projection использует развитый движок graph-ba как
индекс для чтения. Канонический SDD и lifecycle находятся во внешнем владельце,
например в OpenSpec.
...
Это возврат к исходной границе БА-графа с более широким набором источников и
устойчивыми ссылками:
